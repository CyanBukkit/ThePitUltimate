                ...
                if (it == 4) {
                    buttonMap[it] = DisplayButton(
                        ItemBuilder(Material.SKULL_ITEM)
                            .durability(3)
                            .setSkullProperty("")
                            .build(),
                        true
                    )
                    buttonMap[it + 18] = DisplayButton(
                        ItemBuilder(Material.SKULL_ITEM)
                            .durability(3)
                            .setSkullProperty("")
                            .build(),
                        true
                    )
                } else {
