...
public class DefaultHologram extends CraftHologram {
    ...
    public void spawn(long ticks) {
        ...
        }.runTaskLaterAsynchronously(ThePit.getInstance(), ticks);
    }

    @Override
    public boolean spawn(Collection<? extends Player> receivers) {
    ...
    public boolean spawn() {
        return spawn(this.getLocation().getWorld().getPlayers());
    }
    ...
    public void update(long interval) {
        ...
        this.updater.runTaskTimer(ThePit.getInstance(), interval, interval);
    }
